...
export default async function Footer() {
    ...
    // Role-based colors
    const textColor = isRecruiter ? 'text-secondary' : 'text-primary';
    const hoverColor = isRecruiter ? 'hover:text-secondary/90' : 'hover:text-primary/90';

    return (
        <FooterClient>
            <footer className="bg-white text-gray-900 border-t border-gray-300 shadow-sm mt-12">
                            ...
                            <div className="flex space-x-4">
                                {[
                                    ...
                                    <a
                                        ...
                                        className={`text-gray-900 ${hoverColor} transition-colors`}
                                    >
