export default function ButtonFilledPrimary(
    ...
    return (
        <button onClick={onClick}
            className={`px-2 py-1 rounded-3xl border-1 border-primary-200 text-black bg-primary hover:bg-white hover:text-primary transition-all duration-300 ${className}`}>
